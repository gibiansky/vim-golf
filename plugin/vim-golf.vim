" Warning: DO NOT LOOK AT THIS SOURCE FILE.
" THIS SOURCE FILE CONTAINS EMBEDDED ANSWERS TO PARTS OF THE PUZZLE.
" IF YOU ARE STUCK, USE THE HINTS BY USING THE 'hint' COMMAND.
" IF YOU ARE REALLY STUCK, THEN LOOK AT THIS SOURCE FILE.
" ------------------------------------------------------ "
" ------------------------------------------------------ "
" ------------------------------------------------------ "
" ------------------------------------------------------ "
...
" WARNING: ANSWERS AND SPOILERS UPCOMING
...
" Really? You're going to look at these? Come on.
function! One()
